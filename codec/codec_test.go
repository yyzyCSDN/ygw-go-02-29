...
func codecValues() []model.Request {
	return []model.Request{{ID: "one", Name: "First", Status: "ready", Priority: 2, Amount: 12, Active: true, Version: 3, Tags: []string{"blue", "green"}, UpdatedAt: time.Unix(10, 0).UTC()}}
}
