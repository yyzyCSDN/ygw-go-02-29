...
func (manager *Manager) Capture(reason string, values []model.Request) Snapshot {
	manager.mu.Lock()
...
func (manager *Manager) Restore(id uint64) ([]model.Request, error) {
...
func cloneValues(values []model.Request) []model.Request {
