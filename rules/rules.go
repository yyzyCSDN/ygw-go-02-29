...
type Predicate interface {
	Match(model.Request) bool
	Describe() string
}

type PredicateFunc struct {
	Name string
	Test func(model.Request) bool
}

func (predicate PredicateFunc) Match(value model.Request) bool {
...
func (predicates All) Match(value model.Request) bool {
...
func (predicates Any) Match(value model.Request) bool {
	for _, predicate := range predicates {
		if predicate != nil && predicate.Match(value) {
			return true
		}
...
func (predicate Not) Match(value model.Request) bool {
...
func Active() Predicate {
	return PredicateFunc{Name: "active", Test: func(value model.Request) bool { return value.Active }}
}

func Status(status string) Predicate {
	want := strings.ToLower(strings.TrimSpace(status))
	return PredicateFunc{Name: "status=" + want, Test: func(value model.Request) bool {
...
func Tagged(tag string) Predicate {
	...
	return PredicateFunc{Name: "tag=" + want, Test: func(value model.Request) bool { return value.HasTag(want) }}
}

func MinimumAmount(minimum int64) Predicate {
	return PredicateFunc{Name: fmt.Sprintf("amount>=%d", minimum), Test: func(value model.Request) bool {
		return value.Amount >= minimum
	}}
}

func PriorityBetween(minimum, maximum int) Predicate {
	return PredicateFunc{Name: fmt.Sprintf("priority=%d..%d", minimum, maximum), Test: func(value model.Request) bool {
...
func (set *Set) Evaluate(value model.Request) Evaluation {
...
func (set *Set) Select(values []model.Request, name string) ([]model.Request, error) {
	if set == nil {
